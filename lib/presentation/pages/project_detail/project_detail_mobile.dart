...
import 'package:subbu_portfolio/presentation/widgets/project_cover.dart';
...
class ProjectDetailMobile extends StatefulWidget {
  ProjectDetailMobile({required this.projectDetails});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          title: widget.projectDetails!.title,
          actionIcon: Icon(
      ...
      children: [
        ...
        _isHeadingVisible
            ? FlickerTextAnimation(
                text: widget.projectDetails!.subtitle,
