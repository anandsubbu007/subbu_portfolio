...
import 'package:subbu_portfolio/presentation/widgets/project_cover_2.dart';
...
import 'package:subbu_portfolio/presentation/widgets/void.dart';
...
class _ProjectDetailDesktopState extends State<ProjectDetailDesktop>
  ...
  void initState() {
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        setState(() => _isHeadingVisible = true);
  ...
  initTweens() {
    _projectCoverScaleAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Interval(0.0, 0.5, curve: Curves.easeIn),
      ),
    );
    _projectBackgroundScaleAnimation =
    ...
    _projectContentAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
                  ...
                  ContentWrapper(
                    ...
                    child: Row(
                      children: [
                        ...
                        TrailingInfo(
                            width:
                                assignWidth(context: context, fraction: 0.075)),
                      ],
                    ),
                  ),
                ],
    ...
    return Row(
      children: [
        ProjectCover2(
            ...
            imageURLs: widget.projectDetails.imagesList,
            ...
            projectCoverUrl: widget.projectDetails.image),
        SizedBox(
            ...
            children: [
              _isHeadingVisible
                  ? FlickerTextAnimation(
                      text: widget.projectDetails.title,
              ...
              _isContentVisible
                  ? FadeTransition(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.projectDetails.portfolioDescription,
                          ...
                          Text(
                            StringConst.BUILT_WITH +
                                widget.projectDetails.technologyUsed.join(', '),
                                  ...
                                  ? InkWell(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.all(
                                            Sizes.PADDING_8),
                                        child: Image.asset(ImagePath.PLAYSTORE,
                                            width: 24, height: 24),
                                      ),
                                    )
                                  : Emptiness(),
