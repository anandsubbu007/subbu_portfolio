...
import 'package:subbu_portfolio/presentation/widgets/horizontal_bar.dart';
                ...
                Column(
                  children: [
                    ...
                    SocialButton(
                        ...
                        alignment: alignment,
                        onPressed: () {
                          Functions.launchUrl(StringConst.Kaggle_URL);
                        },
                        color: color),
                  ],
                )
        ...
        : IntrinsicHeight(
            child: Row(
              ...
              children: [
                ...
                VerticalDivider(
                    width: Sizes.WIDTH_8, thickness: 2, color: barColor),
                SocialButton(
                  icon: FontAwesomeIcons.telegram,
                  alignment: alignment,
                  onPressed: () {
