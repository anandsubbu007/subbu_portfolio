...
import 'package:subbu_portfolio/presentation/widgets/menu_item.dart' as m;
...
class MenuList extends StatelessWidget {
  MenuList({required this.menuList, this.selectedItemRouteName});
        ...
        Row(
          children: [
            ...
            Icon(FontAwesomeIcons.solidHeart,
                color: Colors.red, size: Sizes.ICON_SIZE_10)
          ],
        ),
        BuildWithWidget(color: AppColors.secondaryColor),
      ],
    );
  }

  List<Widget> _buildMenuList(
      {required BuildContext context, required List<MenuData> menuList}) {
